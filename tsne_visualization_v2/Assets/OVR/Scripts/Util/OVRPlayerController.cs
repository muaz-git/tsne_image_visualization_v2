...
public class OVRPlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Left Right Movement
        if (Input.GetKey(KeyCode.RightArrow) || Input.GetKey(KeyCode.D) || OVRInput.Get(OVRInput.RawButton.RThumbstickRight))
        {
        ...
        if (Input.GetKey(KeyCode.LeftArrow) || Input.GetKey(KeyCode.A) || OVRInput.Get(OVRInput.RawButton.RThumbstickLeft))
        {
            var vec = Quaternion.Euler(0, -90, 0) * transform.forward;
            transform.position += vec * Time.deltaTime * speed;
        }
        if (Input.GetKey(KeyCode.DownArrow) || Input.GetKey(KeyCode.S) || OVRInput.Get(OVRInput.RawButton.RThumbstickDown))
        {
            transform.position -= transform.forward * Time.deltaTime * speed;
        }
        if (Input.GetKey(KeyCode.UpArrow) || Input.GetKey(KeyCode.W) || OVRInput.Get(OVRInput.RawButton.RThumbstickUp))
        {
            transform.position += transform.forward * Time.deltaTime * speed;
        }
        if (Input.GetKey(KeyCode.Q )|| OVRInput.Get(OVRInput.RawButton.LThumbstickUp))
        {
            transform.position += transform.up * Time.deltaTime * speed;
        }
        if (Input.GetKey(KeyCode.E) || OVRInput.Get(OVRInput.RawButton.LThumbstickDown))
        {
            transform.position -= transform.up * Time.deltaTime * speed;
        }
        // Roation
        if (Input.GetKey(KeyCode.Y) || OVRInput.Get(OVRInput.RawButton.LThumbstickLeft))
        {
            transform.localRotation *= Quaternion.Euler(0, -30 * Time.deltaTime, 0);
        }
        if (Input.GetKey(KeyCode.C) || OVRInput.Get(OVRInput.RawButton.LThumbstickRight))
        {
            transform.localRotation *= Quaternion.Euler(0, 30 * Time.deltaTime, 0);
        }
